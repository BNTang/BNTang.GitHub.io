...
randomWords.forEach(word => {
    wordDotsMap[word] = MyMath.literalLattice(word, 3, 'bold', 'Gabriola,华文琥珀', '90px');
});
...
const soundManager = {
    // baseURL: './audio/',
    baseURL: 'https://cdn.jsdelivr.net/gh/BNTang/cdnRepository@476e06dd49a5362a44d5084d6dc62f27091a37c8/fireworks/audio/',
...
const imageTemplateManager = {
    ...
    baseURL: 'https://cdn.jsdelivr.net/gh/BNTang/cdnRepository@476e06dd49a5362a44d5084d6dc62f27091a37c8/fireworks/images/template/',
    sources: [],
    preload() {
        let i = 1;
        let max = 2;
